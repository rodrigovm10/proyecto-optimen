...
function CarouselSection({
	...
	return (
		<div className="mr-8 ml-8 font-monserrat">
			<section className="mt-[-50px] flex flex-row items-center justify-center py-20 px-8">
				<div className="mr-auto ml-auto w-full max-w-940">
					<div className="grid auto-cols-fr auto-rows-auto grid-cols-2 items-center justify-center gap-y-10 gap-x-10">
